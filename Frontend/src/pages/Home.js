		...
		return (
			<div>
				...
				<div
					...
					<div>
						<p className="HomeText">Thapar Institute of Engineering and Technology</p>
					</div>
				</div>
				<div
					style={{
					...
					<div
						...
						<div
							...
							<div
								...
								<FontAwesomeIcon icon={faMedium} style={{ cursor: "pointer" }} />
								<FontAwesomeIcon icon={faDev} style={{ cursor: "pointer" }} />
							</div>
						</div>
					</div>
				</div>
